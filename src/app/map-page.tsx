...
export default function MapPage({ supabaseUrl, supabaseApiKey }: MapPageProps) {
  ...
  React.useEffect(() => {
    if (!supabaseUrl || !supabaseApiKey) {
      setError("Error: Las variables de entorno de Supabase (SUPABASE_URL, SUPABASE_API_KEY) no están configuradas en el archivo .env. Asegúrate de que el archivo existe y reinicia el servidor.");
    }
